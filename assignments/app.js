let app = new Vue({
    ...
    data(){
        return {
            title: "JS-II",
            emailQuery: "amacgiollapheadair1b@xing.com",
            runners: [{"id":1,"first_name":"Charmain","last_name":"Seiler","email":"cseiler0@wired.com","shirt_size":"2XL","company_name":"Divanoodle","donation":75},
    ...
    methods:{
        findRunnerByEmail() {
            ...
            let runner = this.runners.find(runner => {
                return runner.email === this.emailQuery
            })

            this.runnerByEmail = runner ? `${runner.first_name} ${runner.last_name}` : "No runner found"
